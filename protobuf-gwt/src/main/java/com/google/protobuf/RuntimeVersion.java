...
public final class RuntimeVersion {
  ...
  private static void validateProtobufGencodeVersionImpl(
    ...
    if (major != MAJOR) {
      throw new ProtobufRuntimeVersionException(
          "Detected mismatched Protobuf Gencode/Runtime major versions when loading " + location + ": gencode " + gencodeVersionString + ", runtime " + VERSION_STRING + ". Same major version is required.");
    }
